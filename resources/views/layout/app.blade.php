        ...
        <div class="collapse navbar-collapse" id="navDropdown">
            <ul class="navbar-nav col-12 text-center">
                ...
                <li class="nav-item dropdown col-1">
                    ...
                    <ul class="dropdown-menu text-center">
                        <li><a class="dropdown-item" href="{{route('Vacancies.index')}}">職缺查看</a></li>
                ...
                <li class="nav-item col account d-flex">
                    <div class="col-6"></div>
                    <a class="nav-link col" href="{{route('Login.index')}}"><i class="bi bi-person"></i></a>
                </li>
            </ul>
        </div>
    </nav>
